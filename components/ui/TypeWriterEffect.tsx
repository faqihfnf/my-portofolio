...
export const TypewriterEffect = ({
  ...
  return (
    <div className={cn("text-base sm:text-xl md:text-1xl lg:text-2xl  text-center", className)}>
      {renderWords()}
      <motion.span
        initial={{
          opacity: 0,
...
export const TypewriterEffectSmooth = ({
  ...
  return (
    <div className={cn("flex space-x-1 my-6", className)}>
      ...
      >
        <div
          className="text-xs sm:text-base md:text-xl lg:text:3xl xl:text-5xl bold"
          style={{
            whiteSpace: "nowrap",
          }}
        >
