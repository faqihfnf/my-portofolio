...
export const PinContainer = ({ children, title, href, className, containerClassName }: { children: React.ReactNode; title?: string; href?: string; className?: string; containerClassName?: string }) => {
  ...
  return (
    <Link className={cn("relative group/pin z-50  cursor-pointer", containerClassName)} onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave} href={href || "/"} target="_blank" rel="noopener noreferrer">
      <div
        style={{
          perspective: "1000px",
  ...
  return (
    <motion.div className="pointer-events-none  w-full h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
      <div className=" w-full h-full -mt-7 flex-none  inset-0">
        <div className="relative top-0 inset-x-0  flex justify-center">
          <div className="relative flex space-x-2 items-center z-50 rounded-sm bg-zinc-950 py-2 px-8 ring-1 ring-white/10 ">
